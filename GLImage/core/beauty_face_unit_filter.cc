...
bool BeautyFaceUnitFilter::init() {
  ...
  grayImage_ = SourceImage::create(Util::getResourcePath("resources\\lookup_gray.png"));
  originImage_ = SourceImage::create(Util::getResourcePath("resources\\lookup_origin.png"));
  skinImage_ = SourceImage::create(Util::getResourcePath("resources\\lookup_skin.png"));
  customImage_ = SourceImage::create(Util::getResourcePath("resources\\lookup_light.png"));
  return true;
}
